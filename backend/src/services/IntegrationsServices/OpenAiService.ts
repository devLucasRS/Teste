...
import sendWabaMessageService from "../FacebookServices/WabaService/sendWabaMessageService";
import { sendWabaMessageMediaService } from "../FacebookServices/WabaService/sendWabaMessageMidia";
...
export const handleOpenAi = async (
  ...
  if (openAiIndex === -1) {
    ...
    openai = new OpenAI({
      apiKey:
        "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"
    });
    openai.id = ticket.id;
      ...
      convertTextToSpeechAndSaveToFile(
        ...
        try {
          ...
          if(wbot){
            ...
            const mediaDirectory = `${publicFolder}/${fileNameWithOutExtension}.mp3`
            ...
            const sentMessage = await sendWabaMessageMediaService({
              media,
              ticket,
              isPrivate: false,
              isForwarded: false
